...
- [ ] Full validation, publication, and live verification.
...
Run repository safety, builds, and the full check; then perform the release-gated deployment and live verification without moving rollback deployments.
