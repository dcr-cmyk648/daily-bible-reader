...
| `LIBRARY-002` | **approved design; implementation queued** | Add library browsing, permanent notes, and bounded resource caching. | Accessible book/chapter/overview selectors disable unprepared resources and disclose partial Proverbs coverage; browsing does not complete a day; notes require explicit private/shared visibility; T+7 plus bounded recent resources may persist locally, not the whole library. |
