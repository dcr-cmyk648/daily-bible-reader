...
The bridge inventory now contains 61 records: 45 consulted and included in a synthesis, one additional historical work consulted but not used for a claim, one official schedule source consulted for placement only, 13 major works inventoried as inaccessible, and one rights-uncertain aggregation excluded. Micah 3–4 uses nine commentary/context resources, Micah 5–7 uses fourteen, 1 Peter 5 uses twelve, Nahum 1 uses eleven of twelve consulted commentary resources, and Nahum 2 uses eleven independent resources. `research/working/BRIDGE_SOURCE_COVERAGE.md` records represented and missing categories, disagreements, inaccessible candidates, single-source claims, and rights controls. Source totals exclude mirrors, snippets, and works known only through another bibliography.
