...
The offline Matthew Henry replacement and its activation/operational acceptance
are documented in [Henry v2 operations](docs/HENRY_V2_OPERATIONS.md). It asks the
author for source-supported sentences, tracks one durable reading job through
independent review, and requires exact verified publication before reporting
